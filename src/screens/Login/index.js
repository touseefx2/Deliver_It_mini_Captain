...
function Login(props) {
  ...
  const { attemptToGetCities } = props.cityStore;
  ...
  const [phoneInputFieldborderColor1, setphoneInputFieldborderColor1] =
    useState(theme.color.mainPlaceholderColor);
  const [phoneInputFieldborderColor2, setphoneInputFieldborderColor2] =
    useState(theme.color.mainPlaceholderColor);
  const [phoneInputFieldborderColor3, setphoneInputFieldborderColor3] =
    useState(theme.color.mainPlaceholderColor);
  ...
  const setPhoneInput = (txt, p) => {
    if (p == "phone1") {
      setphone1(txt.replace(/[- #*;,.<>\{\}\[\]\\\/]/gi, ""));
      setphoneF(false), setphoneV(false);
      if (txt.length == phn1MaxLength) {
        phoneInput_2 && phoneInput_2.focus();
      }
    }

    if (p == "phone2") {
      setphone2(txt.replace(/[- #*;,.<>\{\}\[\]\\\/]/gi, ""));
      setphoneF(false), setphoneV(false);
      if (txt.length == phn2MaxLength && phoneFields == 3) {
        phoneInput_3 && phoneInput_3.focus();
      }
      if (txt.length == "") {
        phoneInput_1 && phoneInput_1.focus();
      }
    }

    if (p == "phone3") {
      setphone3(txt.replace(/[- #*;,.<>\{\}\[\]\\\/]/gi, ""));
      setphoneF(false), setphoneV(false);
      if (txt.length == "") {
        phoneInput_2 && phoneInput_2.focus();
      }
  ...
  const phoneNumFormate = () => {
    ...
    if (selectedCountryCode == "+92" || selectedCountryCode == "+91") {
      ...
      setphn2MaxLength(4);
      setphn3MaxLength(3);
      setphn1PlaceHolder("300");
      setphn2PlaceHolder("1122");
      setphn3PlaceHolder("234");
      setphoneFields(3);
    }
    //vietnam
    if (selectedCountryCode == "+84") {
      ...
      setphn2MaxLength(4);
      setphn3MaxLength(2);
      setphn1PlaceHolder("355");
      setphn2PlaceHolder("5528");
      setphn3PlaceHolder("71");
      setphoneFields(3);
    }
    //armenia
    if (selectedCountryCode == "+374") {
      setphn1MaxLength(3);
      setphn2MaxLength(3);
      setphn3MaxLength(null);
      setphn1PlaceHolder("355");
      setphn2PlaceHolder("552");
      setphn3PlaceHolder(null);
      setphoneFields(2);
    }
  };
  ...
  const phoneValidate = () => {
    if (phoneFields == 3) {
      ...
      let phoneValidate = utils.Validation.PhoneValidate(
        Phone,
        selectedCountryCode
      );
  ...
  const gotoOTP = (mobile) => {
    props.navigation.navigate("OTP", { mobile });
  };
  ...
  return (
    <Layout style={styles.container}>
      {/* {showInternetMessage && (
        <utils.TopMessage screen="Login" msg="Please connect internet" />
      )} */}
      <View style={styles.Bottom}>
        <theme.Text
          style={{ fontSize: 16, color: theme.color.mainPlaceholderColor }}
        >
          Enter phone number
        </theme.Text>
        <View
        ...
        >
          ...
          <ModalSelector
            ...
            selectStyle={{
              borderColor: theme.color.mainPlaceholderColor,
            ...
            onChange={(option) => {
              setselectedCountryCode(option.label);
            }}
          />
          ...
          <TextInput
            ...
            placeholder={phn1PlaceHolder}
            value={phone1}
            maxLength={phn1MaxLength}
            defaultValue={phone1}
            onFocus={() => focusField("phone1")}
            placeholderTextColor={theme.color.mainPlaceholderColor}
            style={[
              styles.phoneinput,
              {
                borderColor:
                  phoneF || phoneV ? "red" : phoneInputFieldborderColor1,
                backgroundColor: "white",
                color: "black",
              },
            ]}
            onChangeText={(txt) => {
              setPhoneInput(txt, "phone1");
            }}
          />
          ...
          <TextInput
            ...
            editable={!loader}
            keyboardType="number-pad"
            placeholder={phn2PlaceHolder}
            value={phone2}
            maxLength={phn2MaxLength}
            defaultValue={phone2}
            onFocus={() => focusField("phone2")}
            placeholderTextColor={theme.color.mainPlaceholderColor}
            style={[
              styles.phoneinput,
              {
                borderColor:
                  phoneF || phoneV ? "red" : phoneInputFieldborderColor2,
                backgroundColor: "white",
                color: "black",
              },
            ]}
            onChangeText={(txt) => {
              setPhoneInput(txt, "phone2");
            }}
          />
          ...
          {phoneFields == 3 && (
            <TextInput
              ...
              keyboardType="number-pad"
              placeholder={phn3PlaceHolder}
              value={phone3}
              maxLength={phn3MaxLength}
              defaultValue={phone3}
              onFocus={() => focusField("phone3")}
              placeholderTextColor={theme.color.mainPlaceholderColor}
              style={[
                styles.phoneinput,
                {
                  borderColor:
                    phoneF || phoneV ? "red" : phoneInputFieldborderColor3,
                  backgroundColor: "white",
                  color: "black",
                },
              ]}
              onChangeText={(txt) => {
                setPhoneInput(txt, "phone3");
              }}
            />
          )}
        </View>
