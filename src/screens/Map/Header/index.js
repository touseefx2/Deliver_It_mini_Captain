...
function Header(props) {
  ...
  const CustomComponent = () => {
    return (
      <utils.vectorIcon.Entypo
        size={15}
        name={activeChecked ? "check" : "cross"}
        color={activeChecked ? "#19b05e" : "#7d989e"}
      />
    );
  };
  ...
  const toggleActive = (s) => {
    if (activeChecked == true) {
      Alert.alert(
        "Go offline",
        "You will not get bookings after you go offline.",
        [
          {
            text: "Cancel",
      ...
      Alert.alert("Start getting bookings", "Do you want to go online?", [
        {
          text: "Cancel",
          onPress: () => console.log("Cancel Pressed"),
          style: "cancel",
